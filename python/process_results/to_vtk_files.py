...
def main(args=[]):
    parser = argparse.ArgumentParser(description='Make a bunch of vtk files with the sequence')
    parser.add_argument('results_file', metavar='F', type=str,  help='result file to process')
    parser.add_argument('output_folder', metavar='F', type=str,  default=".", help='result file to process')
