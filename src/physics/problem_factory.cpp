...
namespace physics {
    ...
    {
        problems_.emplace("rigid_body_problem", std::make_shared<RigidBodyProblem>());
        problems_.emplace(
            "particles_problem", std::make_shared<ParticlesDisplProblem>());
    ...
    ProblemFactory::get_problem(const std::string& problem) const
    {
