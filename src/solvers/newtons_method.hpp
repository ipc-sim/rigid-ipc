...
namespace opt {
     ...
     * @param[in]  make_psd  If delta_x is not a descent direction, then make
     *                       the hessian positive semi-definite.
     *
    ...
    /**
     * @brief Solve for the newton direction for the limited degrees of freedom.
     *
     * The fixed dof of x will have a delta_x of zero.
     *
     * @param[in]  gradient  Gradient of the free dof of the objective function.
     * @param[in]  hessian   Hessian of the free dof of the objective function.
