...
namespace autodiff {
    ...
    /**
    * \brief Given toi returns the position \f$\alpha\f$ along the \f$edge_{ij}\f$ where the impact
    * between vertex \f$k\f$ and \f$edge_{ij}\f$  takes place.
    *
    *   @param[in]   V_{i,j,k}       : vertex positions
    *   @param[in]   U_{i,j,k}       : vertex displacements
    *   @param[in]   toi             : time of impact
    *
    *   @param[out]  alpha          : position along the \f$edge_{ij}\f$ where the impact takes place
    *
