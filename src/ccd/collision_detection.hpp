 ...
 *
 * @param[in] vertex0             The vertex to find the spatial
 *                                parameterization along the edge at time t.
 * @param[in] displacment0        The displacement of vertex0 over the time-step
 ...
 *
 * @param[out] alpha              The spatial parameterization, \f$s\f$, such
 *                                that \f$p_0(t) = (p_2(t) - p_1(t))*s +
 *                                p_1(t)\f$. The computed output value is stored
 *                                in this variable.
 ...
 * @param[in] edge_vertex1        The position, in 2D, of the first endpoint of
 *                                the edge.
 * @param[in] edge_displacement1  The displacement, in 2D, of the first endpoint
 *                                of the edge.
 * @param[in] edge_vertex1        The position, in 2D, of the second endpoint of
 *                                the edge.
 * @param[in] edge_displacement1  The displacement, in 2D, of the second
 *                                endpoint of the edge.
 *
 * @param[out] toi                The time of impact, \f$\tau_I \in [0, 1]\f$,
 *                                where the start of the time-step is at
 *                                \f$t=0\f$ and the end of the time-step is at
 *                                time \f$t=1\f$. The computed output value is
 *                                stored in this variable.
 * @param[out] alpha              The spatial position of the impact along the
 *                                edge, \f$\alpha \in [0, 1]\f$, where the start
 *                                of the edge is at \f$\alpha=0\f$ and the end
 *                                of the edge is at time \f$\alpha=1\f$. The
 *                                computed output value is stored in this
 *                                variable.
...
void detect_edge_vertex_collisions_brute_force(const Eigen::MatrixXd& vertices,
    const Eigen::MatrixXd& displacements, const Eigen::MatrixX2i& edges,
    EdgeVertexImpacts& ev_impacts, bool reset_impacts = true);
