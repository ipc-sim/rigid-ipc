    ...
    const Interval& v)
{
    ...
    PoseI pose = PoseI::interpolate(pose_t0, pose_t1, t);
    // Get the world vertex of the edges at time t
    Eigen::VectorX3I f0 = body.world_vertex(pose, body.edges(face_id, 0));
    Eigen::VectorX3I f1 = body.world_vertex(pose, body.edges(face_id, 1));
    Eigen::VectorX3I f2 = body.world_vertex(pose, body.edges(face_id, 2));
