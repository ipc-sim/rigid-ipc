...
namespace opt {
        ...
        Eigen::MatrixX2d& Uopt)
    {
        ...
        case MMA:
        case SLSQP:
            displacements_optimization_nlopt(V, U, E, volume_epsilon,
    ...
    //     const double barrier_beta, const DetectionMethod
    //     ccd_detection_method, Eigen::MatrixX2d& Uopt)
    // {
    //
    ...
    //     /// @param[in] x        : flattened vector with the updated
    //     velocities
    ...
    //         ccd::compute_volumes(
    //             V, u, E, ee_impacts, edge_impact_map, volume_epsilon,
    //             volumes);
    //
    ...
    //         convert_edge_vertex_to_edge_edge_impacts(E, ev_impacts,
    //         ee_impacts);
    //
