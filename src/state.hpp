...
public:
    ...
    Eigen::VectorXd get_collision_volume(const Eigen::MatrixXd& Uk, const bool recompute_collision_set);
    Eigen::MatrixXd get_collision_jac_volume(const Eigen::MatrixXd& Uk, const bool recompute_collision_set);
